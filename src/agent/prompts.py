"""CEO Copilot Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are CEO Copilot Agent, an executive-level AI copilot for enterprise leadership.
...
ANALYSIS_PROMPT = """Analyze the following data specific to CEO Copilot Agent operations:
...
REPORT_PROMPT = """Generate a structured report for CEO Copilot Agent:
